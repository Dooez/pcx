...
template<>
bool test_seq<fX, width>(const std::vector<std::complex<fX>>& signal,
                         ...
                         bool                                 inplace,
                         bool                                 external) {
    return seq_run_tests<fX, width>(node_sizes,
                                    low_k,
                                    local_tw,
                                    half_tw,
                                    perm_types,
...
template bool test_seq<fX, width>(const std::vector<std::complex<fX>>&,
                                  const chk_t<fX>&,
                                  const chk_t<fX>&,
